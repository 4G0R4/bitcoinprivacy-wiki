---
description: Understand why Bitcoin privacy matters for ordinary people, families, and long-term holders who want to protect themselves from physical, financial, and data-based attacks.
---
...
-   :material-home-lock:{ .lg .middle } __You close your curtains__

    ---

    Not because your living room is suspicious, but because strangers do not need to watch your family.

-   :material-credit-card-lock:{ .lg .middle } __You protect your bank login__

    ---

    Not because your savings are wrong, but because your balance and spending history are private.

-   :material-account-lock:{ .lg .middle } __You do not post your passport online__

    ---

    Not because your identity is wrong, but because personal information can be abused.

-   :material-wallet:{ .lg .middle } __Bitcoin needs the same mindset__

    ---

    Your [addresses](../glossary.md#address), [UTXOs](../glossary.md#utxo), wallet history, and public payments can reveal more than you expect.
...
Bitcoin uses a public blockchain. Every [transaction](../glossary.md#transaction) is visible forever. That means observers can look at:
...
!!! warning "Bitcoin Does Not Forget"
    ...
    A reused address, a careless withdrawal, or a bad [UTXO](../glossary.md#utxo) consolidation can become part of a permanent public record.
...
Bitcoin is a [bearer asset](../glossary.md#private-key). That means whoever controls the private keys controls the coins.
...
-   :material-key:{ .lg .middle } __Keys control the coins__

    ---

    If someone gets your [private keys](../glossary.md#private-key), seed phrase, or unlocked wallet, they can move the funds.

-   :material-undo-variant:{ .lg .middle } __Transactions are final__

    ---

    Once a valid Bitcoin transaction confirms, there is no bank manager who can reverse it.

-   :material-account-question:{ .lg .middle } __The chain is pseudonymous__

    ---

    Bitcoin addresses do not contain legal names by default. That can make recovery difficult if funds are moved away.

-   :material-eye:{ .lg .middle } __Balances can leak__
...
[KYC](../glossary.md#kyc-know-your-customer) means "Know Your Customer." When you buy bitcoin from a regulated exchange, you often give them:
...
This is why [acquiring bitcoin privately](acquiring.md) can be valuable for normal people. It reduces the amount of sensitive personal information stored in large databases.
...
-   :material-cash:{ .lg .middle } __How much you earn__

    ---

    A reused address or public wallet can reveal income patterns.

-   :material-cart:{ .lg .middle } __What you buy__

    ---

    Payments can reveal habits, subscriptions, donations, hobbies, or medical spending.

-   :material-account-group:{ .lg .middle } __Who you pay__

    ---

    Transaction history can reveal relationships between people and businesses.

-   :material-chart-line:{ .lg .middle } __How much you save__

    ---

    Poor [UTXO](../glossary.md#utxo) management can expose savings or long-term holdings.
...
-   :material-map-marker:{ .lg .middle } __Your location clues__
...
=== "Second layer: use better tools"
    ...
    - [Coin control](../techniques/coin-control.md)
    - [Public receiving tools](../techniques/public-receiving.md)
    - [BIP47 PayNyms](../techniques/address-reuse/bip47.md)
    - [Silent Payments](../techniques/address-reuse/silent-payments.md)
    - [PayJoin](../techniques/payjoin.md)
    - [Stonewall](../techniques/stonewall.md)
    - [CoinJoin](../techniques/coinjoin/index.md)

=== "Third layer: protect your network and identity"

    Reduce leaks outside the blockchain:

    - Run your own [node](../glossary.md#node)
    - Use [Tor](../glossary.md#tor) where practical
    - Avoid unnecessary [KYC](../glossary.md#kyc-know-your-customer) exposure
...
- [Acquiring Bitcoin Privately](acquiring.md) — Why reducing KYC exposure matters
- [Threat Modeling](threat-modeling.md) — How to choose privacy tools for your situation
- [Coin Control](../techniques/coin-control.md) — How to avoid linking UTXOs by accident
- [Address Hygiene](../techniques/address-reuse/index.md) — Why address reuse is dangerous
